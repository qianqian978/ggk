...
(function($)
{
	...
	{
		width			: 300,					// set width - best to match image width
		height			: 130,					// set height - best to match image height
		image			: null,	                // set image path
		image2          : 'image/guaback2.png',
...
//$($this.canvas).css('margin-top', $($this.canvas).css('margin-top') == '0px'? '1px': '0px');
		},
